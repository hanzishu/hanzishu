...
After downloading the file, if browser prompts you "Open in other app", you can choose to not save the file to local folder, instead, you can  choose to use the recently installed "Hamster" engine program to open the file, then you can skip the FOURTH STEP.
